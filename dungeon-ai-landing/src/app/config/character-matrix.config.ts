...
export type FacingDirection = 'front' | 'left' | 'right' | 'back';
...
// TORSO FRONT - Default pose, looking at viewer (v4.4 SLIM TORSO)
const TORSO_FRONT = `
....000000000....
....00.E.E.00....
....00..S..00....
...
// TORSO RIGHT - Looking/walking to the right (v4.4 SLIM TORSO)
const TORSO_RIGHT = `
....000000000....
....00..E.E.0....
....00...S.00....
...
// TORSO LEFT - Looking/walking to the left (v4.4 SLIM TORSO)
const TORSO_LEFT = `
....000000000....
....0.E.E..00....
....00.S...00....
...
// TORSO BACK - Facing away from viewer (v4.5 HOLOGRAM ACTIVATION)
// Cabeza completamente DENSA - sin ojos, sin boca, sin patron visible
// El robot da la espalda al jugador mirando hacia el pilar/holograma
const TORSO_BACK = `
....000000000....
....000000000....
....000000000....
...
export function getTorsoGrid(facing: FacingDirection = 'front'): BinaryDigit[][] {
  switch (facing) {
    ...
    case 'back': return parseShape(TORSO_BACK);
