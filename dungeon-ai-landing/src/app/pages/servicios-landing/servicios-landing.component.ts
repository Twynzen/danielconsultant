...
export class ServiciosLandingComponent implements OnInit, OnDestroy {
  ...
  readonly modes: ServiceMode[] = [
      ...
      plans: [
        {
          ...
          price: '$0',
          period: 'Para siempre',
          features: ['1 agente', 'Memoria ilimitada', 'WhatsApp'],
          cta: 'Empezar gratis',
        },
        {
          name: 'Starter',
          price: '$35',
          period: '/mes',
          features: ['Memoria ilimitada', 'WhatsApp + WebChat', 'Recordatorios básicos', 'Soporte por email'],
          cta: 'Probar Starter',
        },
        {
          name: 'Plus',
    ...
    },
    {
      ...
      heroAccent: 'con Agentes Guardian',
